...
def run(
    ...
    coordinator_host: str | None = typer.Option(
        None,
        "--coordinator-host",
        help="Optional coordinator host (accepted for compatibility; not required to run)",
    ),
    coordinator_port: int | None = typer.Option(
        None,
        "--coordinator-port",
        help="Optional coordinator port (accepted for compatibility; not required to run)",
    ),
