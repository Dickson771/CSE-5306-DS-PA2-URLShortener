...
def add_RaftServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'consensus.Raft', rpc_method_handlers)
...
class Raft(object):
    ...
    def RequestVote(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/consensus.Raft/RequestVote',
    ...
    def AppendEntries(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/consensus.Raft/AppendEntries',
    ...
    def ClientCommand(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/consensus.Raft/ClientCommand',
